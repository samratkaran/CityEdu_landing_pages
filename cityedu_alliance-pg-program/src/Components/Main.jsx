        ...
        <div className="row main-head-text-of-landing-page">
          <div className="col-md-8 text-white">
            ...
            <p className="second-head-text-of-page"> MBA Program</p>
             ...
             Accredited by International Accreditation Council for Business Education (IACBE), USA
      ...
      <div className="main-container mb-5">
        <div className="row main-overview-of-page">
          ...
          <div className="col-md-11 p-3">
            <p>
              {" "}
              Established in 2010, the Alliance School of Business (ASB) is an integral part of Alliance University, a distinguished institution accredited by the University Grants Commission (UGC) and the All India Council for Technical Education (AICTE). Alliance School of Business offers a comprehensive range of undergraduate and postgraduate programs in business administration, including Bachelor of Business Administration (BBA), Bachelor of Commerce (B.Com.), Master of Business Administration (MBA), Master of Commerce (M.Com.), and Doctor of Philosophy (Ph.D.) in Business Administration.
            </p>
          </div>
        </div>
...
<p>A relaxation of 5% marks or its equivalent grade may be allowed for those belonging to SC/ST.</p>
<p>For MBA, Alliance School of Business will accept any one of the national-level management aptitude tests or Alliance Management Aptitude Test (AMAT).</p>
</div>
...
<p><strong>Vertical Disciplines</strong></p>
<ul>
<li>Finance</li>
<li>Operations Management</li>
<li>Marketing</li>
...
<p><strong>Horizontal Disciplines</strong></p>
...
<div class="col-md-4 border py-3">
<p><strong>Choice-Based Electives</strong></p>
<ul>
...
<p class="small"><em>Three subjects will be offered under the chosen choice-based elective</em></p>
</div>
...
<li>Introduction to Human Factors and Ergonomics (By Vivek Kant, PhD. | IIT Bombay)</li>
          ...
          <div className="col-md-11 m-auto">
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                Are there any international exchange programs for students at ASB?
                </Accordion.Header>
                <Accordion.Body>
                 
                Yes, ASB has established partnerships with leading business schools globally, providing students with opportunities for international exchange programs. This allows them to gain a global perspective and experience studying abroad.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                ASB has a dedicated Career Advancement and Networking cell that organizes workshops, seminars, and mentorship programs. Additionally, the Center for Industry Interface facilitates interactions with industry experts, enhancing students' career prospects.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="2">
                <Accordion.Header>
                Can students pursue dual specializations in their MBA program at ASB?
                </Accordion.Header>
                <Accordion.Body>
                Yes, ASB allows students to pursue dual specializations in their MBA program. This provides them with a comprehensive skill set and a competitive edge in the job market.
                </Accordion.Body>
              </Accordion.Item>
